...
public class JazzyHelper implements AbsListView.OnScrollListener {
    ...
    public JazzyHelper(Context context, AttributeSet attrs) {
        ...
        int transitionEffect = a.getInteger(R.styleable.PullToRefresh_effect, STANDARD);
        int maxVelocity = a.getInteger(R.styleable.PullToRefresh_max_velocity, MAX_VELOCITY_OFF);
        mOnlyAnimateNewItems = a.getBoolean(R.styleable.PullToRefresh_only_animate_new_items, false);
        mOnlyAnimateOnFling = a.getBoolean(R.styleable.PullToRefresh_max_velocity, false);
        mSimulateGridWithList = a.getBoolean(R.styleable.PullToRefresh_simulate_grid_with_list, false);
        a.recycle();
